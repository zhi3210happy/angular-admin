...
export class PersonEditComponent implements OnInit {
    ...
    constructor(
        ...
        this.personName = this.activeRoute.snapshot.params.id;
    }
    ...
    initFrom() {
        this.personManageService.getPersonByName(this.personName).subscribe(personArr => {
            this.person = personArr.filter(person => person.name === this.personName)[0];
    ...
    onSubmit() {
        ...
        this.personManageService.updatePerson(this.personName,this.form.value).subscribe({
            next: () => { 
                SweetAlert.alert('修改人员成功');
